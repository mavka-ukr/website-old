...
const diia = () => {
  ...
  return {
    ...
    keywords: {
      ...
      keyword:
        "та ціль макет субʼєкт це дія рівно більше менше макет пак спробувати містить не я js файл впасти тривала зловити є перебрати кінець структура чекати взяти якщо або і інакше вернути поки як дати модуль пропустити зупинити",
      literal:
        "так ні пусто текст логічне число список словник словник_м список_м текст_м число_м логічне_м обʼєкт ніщо щось []ніщо []щось []текст []логічне []число []список []словник"
    },
    unicodeRegex: true,
    contains: [
      {
