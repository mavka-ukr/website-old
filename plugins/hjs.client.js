...
const diia = () => {
    ...
    return ({
        ...
        keywords: {
            ...
            keyword: 'дія рівно більше менше спробувати не впасти тривала зловити є перебрати повернути кінець структура для чекати включити має взяти якщо або і інакше вернути поки як дати модуль',
