...
const diia = () => {
    ...
    return ({
        ...
        keywords: {
            ...
            keyword: 'дія рівно більше менше макет пак спробувати не впасти тривала зловити є перебрати кінець структура чекати взяти якщо або і інакше вернути поки як дати модуль пропустити зупинити',
