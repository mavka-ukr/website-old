...
const diia = () => {
  ...
  return {
    ...
    keywords: {
      ...
      keyword:
        "та композиція перелік риса втілює зовн внут біб імп спец власна ціль макет субʼєкт це дія рівно більше цикл менше макет пак спробувати містить не я js файл впасти тривала зловити є перебрати кінець структура чекати взяти якщо або і інакше вернути поки як дати модуль пропустити зупинити",
      literal:
...
const diiaSpecial = () => {
  ...
  return {
    ...
    keywords: {
      $pattern: /[a-zA-Zа-яА-ЯіІїЇєЄ_ʼ]+/,
      keyword:
        "макет субʼєкт це дія рівно більше менше макет пак спробувати містить не я js файл впасти тривала зловити є перебрати структура чекати взяти якщо або і інакше вернути цикл поки як дати модуль пропустити зупинити",
      literal:
