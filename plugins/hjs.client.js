...
const diia = () => {
  ...
  return {
    ...
    keywords: {
      ...
      literal:
        "так ні перебір перебір_з_ключем пусто символ текст логічне число список словник обʼєкт ніщо обʼєкт щось байти",
    },
    unicodeRegex: true,
    contains: [
      {
...
const diiaSpecial = () => {
  ...
  return {
    ...
    keywords: {
      $pattern: /[a-zA-Zа-яА-ЯіІїЇєЄ_ʼ]+/,
      keyword:
        "макет це дія рівно більше менше макет пак спробувати містить не я js файл впасти тривала зловити є перебрати структура чекати взяти якщо або і інакше вернути цикл поки як дати модуль пропустити зупинити",
      literal:
        "так ні пусто текст символ логічне число список словник словник_м список_м текст_м число_м логічне_м обʼєкт щось []ніщо []щось []текст []логічне []число []список []словник",
    },
    unicodeRegex: true,
    contains: [
      {
