...
спробувати
  ...
  друк("крок 2...")
  друк("крок 3...")
  впасти "помилка крок 3!"
  друк("крок 4...")
  друк("крок 3...")
зловити п
  друк("не вдалось виконати запуск: %(п.повідомлення)")
кінець
`.trim();
...
<template>
  <DocsWrapper>
    ...
    <p>
      ...
      зловити цю помилку та якось її обробити. Спроби є аналогом до <code>try/catch</code> в інших мовах.
    </p>
