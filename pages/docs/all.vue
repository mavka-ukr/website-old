...
ні
`.trim();
const undefined_basic = `
пусто
`.trim();
const diia_basic = `
дія Багатокутник.запустити(а число = М.випадкове(), б текст = "А Б В Г ...", в )
  друк("Організм успішно запущено.")
кінець
`.trim();
const structure_basic = `
структура Багатокутник
  назва текст = "трикутник"
  кутів число = 3
  згладжування
кінець
`.trim();
