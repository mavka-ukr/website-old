...
const diia = `
дія для Паспорту п змінити_ім'я(нове_ім'я)
  п.ім'я = нове_ім'я
кінець
`.trim();
...
<template>
  <DocsWrapper>
    ...
    <p>
      Структура є способом опису даних, для поміщення їх в одне місце.
      Структура має назву, може мати властивості (опис даних) та дії (операції над даними).
      Дані, поміщені в одне місце за певною структурою, називаються об'єктом.
    </p>
