...
const eachStructureSpecCreateMethod = `спец дія перебір.створити<З>(завершено логічне, значення З, далі Дія) перебір<З>`;
const eachStructureNextMethod = `дія перебір.далі()`;
