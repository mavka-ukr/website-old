...
const textStructureMagicAddMethod = `дія текст.чародія_додати(значення текст) текст`;
const textStructureMagicIteratorMethod = `дія текст.чародія_перебір() перебір<символ>`;
const textStructureMagicIteratorWithKeyMethod = `дія текст.чародія_перебір_з_ключем() перебір_з_ключем<число, текст>`;
const textStructureMagicContainsMethod = `дія текст.чародія_містить(значення текст) логічне`;
const textStructureMagicGetMethod = `дія текст.чародія_отримати(позиція число) символ`;
const textStructureMagicNumberMethod = `дія текст.чародія_число() число`;
...
<template>
  <UiDocsWrapper prev="/документація/число" next="/документація/логічне">
    ...
    <p>
      ...
      обʼєктом <span class="diia-word">Мавки</span>, що зберігає послідовність
      символів.
    </p>
    <p>
      Текст описано
    ...
    <p>
      Текст записується між символами подвійних лапок
      <span style="font-weight: 500" class="hljs-keyword">або</span>
      трьома символами подвійних лапок.
    </p>
    ...
    <h3>Структура символу</h3>
    <UiCodeBlock :files="charStructure" />
    <hr />
    <h3>Дії тексту</h3>
    <p>
      <code>розбити</code>
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      розбиття тексту за певним роздільником.
    </p>
    ...
    <p>
      <code>замінити</code>
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      заміни частини тексту на інший текст.
    </p>
    <UiCodeBlock :files="textStructureReplaceMethod" />

    <p>
      <code>починається</code>
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      перевірки чи текст починається певним текстом.
    </p>
    <UiCodeBlock :files="textStructureStartsWithMethod" />

    <p>
      <code>закінчується</code>
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      перевірки чи текст закінчується певним текстом.
    </p>
    ...
    <p>
      ...
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      видалення з початку
      <span style="font-weight: 500" class="hljs-keyword">і кінця</span> тексту
      певних символів.
    </p>
    ...
    <p>
      ...
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      обʼєднання тексту з іншим текстом.
    </p>
    ...
    <p>
      ...
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      перевірки чи текст
      <span style="font-weight: 500" class="hljs-keyword">містить</span> інший
      текст.
    </p>
    ...
    <p>
      ...
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      отримання символа з тексту за певною позицією.
    </p>
    ...
    <p>
      ...
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
      отримання перебору символів тексту.
    </p>
    <UiCodeBlock :files="textStructureMagicIteratorMethod" />

    <p>
      <code>чародія_число</code>
      <span style="font-weight: 500" class="hljs-keyword">це дія</span> для
