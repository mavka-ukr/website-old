...
`.trim(),
  },
  {
    ...
    text: `
взяти біб дід
взяти біб сервер [запустити, Опції, Запит, Відповідь]

запустити(
  дія(запит Запит)
    якщо запит.шлях == "/машини"
      вернути дід.зібрати(
...
чекати відповідь = запит.надіслати(урл="https://мавка.укр/машини")
машини = дід.розібрати<список<текст>>(текст(відповідь.дані))
