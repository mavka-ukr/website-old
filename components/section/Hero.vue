...
відповідь = чекати отримати("тачки.укр/пі/ауді")

кожній авто беручи відповідь.дд()
  друк(авто.назва)
кінець
`.trim(),
  },
  ...
  <section class="hero">
    ...
    <div class="left">
      ...
      <h5 class="hero-subtitle">
        Дія - це експериментальна мова програмування, що дозволяє кожному писати програми українською мовою.
      </h5>
