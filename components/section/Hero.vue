...
чекати автомобілі = отримати("дані.тачки.укр")

перебрати автомобілі як авто
  друк(авто.назва)
кінець
`.trim(),
  },
  ...
  <section class="hero">
    ...
    <div class="left">
      ...
      <h5 class="hero-subtitle">
        <span class="diia-word">Мавка</span> - це експериментальна мова програмування, що дозволяє кожному реалізовувати ідеї українською мовою.
